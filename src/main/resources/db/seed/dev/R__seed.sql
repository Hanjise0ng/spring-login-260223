...
VALUES
    ((SELECT user_id FROM users WHERE public_id = '00000000-0000-0000-0000-0000000000a1'),
     'LOCAL', 'admin1234',
     '$2a$10$UeP9roeoADKdfzkkE59FteHkPRAWHXt3Q8PtZZJEzkRbWl/amOg5O', -- pw: admin1234!
     NOW(6), NOW(6)),
    ((SELECT user_id FROM users WHERE public_id = '00000000-0000-0000-0000-0000000000a2'),
     'LOCAL', 'user1234',
